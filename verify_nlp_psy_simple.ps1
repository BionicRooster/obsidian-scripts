# Simple verification script to count files with NLP_Psy tag
...
Write-Output "Files with NLP_Psy tag: $withTag"
Write-Output "Files without NLP_Psy tag: $withoutTag"
Write-Output "Files not found: $notFound"
Write-Output "Files skipped: $skipped"
Write-Output "Total processed: $($withTag + $withoutTag)"
Write-Output "=========================================="

if ($withoutTag -gt 0) {
    Write-Output ""
    Write-Output "Note: $withoutTag file(s) are missing the NLP_Psy tag"
}

if ($missingList.Count -gt 0) {
    Write-Output ""
    Write-Output "Files not found in vault:"
