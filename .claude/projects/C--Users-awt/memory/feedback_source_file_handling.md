...
**How to apply:** Any time a conversion workflow ends, verify the source file was moved to `09 - Attachments`, not deleted. Only delete source files if the user explicitly says to delete them.
