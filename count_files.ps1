...
$remaining20 = (Get-ChildItem -Path "C:\Users\awt\Sync\Obsidian\20 - Permanent Notes" -Filter "*.md" | Where-Object { $_.Name -ne "20 - Permanent Notes.md" }).Count
Write-Host "`nRemaining in 20 - Permanent Notes: $remaining20"

# Check remaining in 10 - Clippings
$remaining10 = (Get-ChildItem -Path "C:\Users\awt\Sync\Obsidian\10 - Clippings" -Filter "*.md").Count
