...
$results = Get-ChildItem 'D:\Obsidian\Main' -Recurse -Filter '*.md' -ErrorAction SilentlyContinue | ForEach-Object {
...
Get-ChildItem 'D:\Obsidian\Main' -Recurse -Filter '*.md' -ErrorAction SilentlyContinue | Where-Object {
